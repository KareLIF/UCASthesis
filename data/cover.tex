...
\cdegree{理学硕士}
\cdepartment[声学所]{中国科学院声学研究所}
\cmajor{声学}  %写一级学科名称
\cauthor{汪\hspace{1em}恺} 
\csupervisor{李风华\hspace{1em}研究员}
\csupervisorplace{中国科学院声学研究所}
...
% 这块比较复杂，需要分情况讨论：
% 1. 学术型硕士
%    \edegree：为Master of Science Doctor of Philosophy注意大小写）
...
\eauthor{Wang Kai}
\edepartment{Institute of Acoustics\\Chinese Academy of Sciences}
\emajor{Acoustics}   %写一级学科名称
\esupervisor{Li Fenghua}

% 这个日期也会自动生成，你要改么？
% \edate{December, 2016}
% postdoctordate{2009 年 7 月——2011 年 7 月} % 博士后研究起止日期
